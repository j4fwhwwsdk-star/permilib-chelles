  ...
  return (
    <div style={{ background: "linear-gradient(180deg, #081428 0%, #0b1d38 100%)", minHeight: "100vh" }}>
      ...
      <section className="relative pt-24 pb-16 px-4 overflow-hidden">
        <div className="absolute -top-10 right-10 w-72 h-72 rounded-full pointer-events-none" style={{ background: "radial-gradient(circle, rgba(22,163,74,0.10) 0%, transparent 70%)" }} />
        ...
        <div className="relative max-w-6xl mx-auto">
          ...
          {/* Boutons rapides dans le hero */}
          <div className="flex flex-col sm:flex-row gap-3 max-w-lg">
            <a
              href={`tel:${PHONE}`}
              className="flex-1 flex items-center justify-center gap-2 bg-green-600 text-white rounded-xl px-6 py-4 font-bold hover:bg-green-500 transition-all duration-300"
            ...
            <a
              ...
              className="flex-1 flex items-center justify-center gap-2 text-white rounded-xl px-6 py-4 font-bold transition-all duration-300 hover:border-white/25"
      ...
      {/* ── Contenu ── */}
      <section className="py-16 px-4" style={{ borderTop: "1px solid rgba(255,255,255,0.07)" }}>
